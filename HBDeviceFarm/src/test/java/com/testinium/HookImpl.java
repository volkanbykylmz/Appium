...
public class HookImpl {
    ...
    public DesiredCapabilities androidCapabilities(boolean isLocal) {
        ...
        capabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, "com.tmobtech.halkbank");
        capabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, "com.halkbank.splash.ui.SplashActivity");


        if (isLocal) {
            capabilities.setCapability(MobileCapabilityType.PLATFORM, MobilePlatform.ANDROID);
            capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "ce10160aad263e1e03");
            ...
            capabilities.setCapability("testinium:key", "");
